<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(auth()->check() && auth()->user()->role === 'author')
                        <x-nav-link :href="route('author.books.create')" :active="request()->routeIs('author.books.create')">
                            {{ __('Upload Book') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                <!-- Dark Mode Toggle -->
                <button @click="toggleDarkMode()" class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200">
                ...
                @else
                    ...
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('login') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 px-3 py-2 text-sm font-medium transition-colors">
                            {{ __('Login') }}
                        </a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('books.public.index')">
                    {{ __('Library') }}
                </x-responsive-nav-link>
